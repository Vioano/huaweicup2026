...
6. **截止时间**：北京时间2026-09-25按父协调；当前只准备，先等待作者固定SHA，再等待父审阅runner与明确START。没有任何自动预算扩展或空闲自启动。
