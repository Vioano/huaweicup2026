...
SOURCE = "a5dafdf94d0694132fb9ec7121f5fe1fe0d6ee3b"
HANDOFF = ROOT / "results/a/q3-nikolastarx/expanded500-handoff-20260925"
AREA = ROOT / "results/a/q3-nikolastarx/expanded-full500-20260925-s59"
...
def preflight():
    ...
    for n in range(1, 11):
        ...
        if value["solver_commit"] != SOURCE or value["solver_module"] != "src.q3.expanded_solve":
...
def main():
    ...
    state = {"schema": "p3-ten-shard-dispatch-v1", "source_commit": SOURCE,
             "handoff_commit": "a0d968df1a028592d6989746829cf693fdec2647",
             "runner_commit": SOURCE, "runner_path": "src/q3/feedback_benchmark.py",
             "controller_path": "scripts/s59ee_p3_expanded_dispatch.py", "controller_sha256": sha(__file__),
