...
- 发布前保留未提交工作，使用固定提交链接和短索引说明新增材料及对任务的影响；重要共享资料合入/发布后同步研究镜像，并在原任务 Issue 通知受影响成员，跟进其实际 HEAD、已读范围和理解变化。成员使用组织主库，队长 Pro 使用已授权镜像；本机、主库、镜像、成员已读是不同状态。归档可供全队读取，但仍遵守专项/isolated 会话阅读清单，不强制所有会话无差别导入全部历史。
