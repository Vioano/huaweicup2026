...
"""
    ...
    manifest = {
        ...
        "source": {
            ...
            "commit": "b305376242ac69caecde02ecd1cf60207fca106b",
...
"""
    ...
    audit = {
        ...
        "panels": [
            {"id": "mean", "description": "left arithmetic mean speedup"},
            {"id": "distribution", "description": "right per-case distribution"},
        ],
