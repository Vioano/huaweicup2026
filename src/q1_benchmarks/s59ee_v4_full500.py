...
HERE = 'src/q1_benchmarks/s59ee_v4_full500.py'
MANIFEST = 'src/q1_benchmarks/s59ee_v4_full500_manifest.json'
RESULTS = ROOT / 'output/p1-v4-full500-s59ee'
...
def check():
    ...
    assert manifest['timeouts_seconds'] == {'solver':300,'external_E0':180,'batch':2400}
