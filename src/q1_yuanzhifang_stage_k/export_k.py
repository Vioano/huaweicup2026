...
def export(run_dir, feed_path):
    ...
    for case, cores in CELLS:
        ...
        missing = {
            ...
            "provenance.environment.threads": "OS thread count was not measured; batch has one cell worker.",
        ...
        records.append({
            "attempt_id": f"fang-q1-stage-k-100k4-oneworker-20260925-{case}-k{cores}-r0", "revision": 1,
            "run_id": "fang-q1-stage-k-100k4-oneworker-20260925", "algorithm_id": "q1-unified-structural-hj-stage-k",
            ...
            "parameters": {"cores": cores, "candidate_limit": 7, "online_e1_worker_limit": 1,
                           ...
                           "batch_budget": {"solver": 100, "E0_new": 8, "E1_attempts": 700, "E2": 0,
                                            "workers": 1, "startup_available_ram_min_bytes": manifest["available_ram_min_bytes"],
                                            "owned_job_memory_limit_bytes": manifest["owned_job_memory_limit_bytes"],
                                            "wall_seconds": 2400, "retries": 0},
            ...
            "artifacts": artifacts, "runtime_id": "fang-windows-q1-stage-k-100k4-oneworker-20260925",
