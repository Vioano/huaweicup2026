"""Admitted one-shot 005/K5 layered-flow diagnostic. Do not use as solver timing."""
    ...
    def observe(frame, event, value):
        ...
        if event == 'return' and phase == 'p3':
            ...
            if name == 'Task3':
                ...
                try:
                    receipt['guard'] = check_layered_prepared(graph, plan, captured, layers=3)
...
def run_phase(args, phase, deadline, report):
    ...
    cmd = [sys.executable, '-B', '-m', 'src.q3.layered_query_flow_probe', str(args.candidate),
