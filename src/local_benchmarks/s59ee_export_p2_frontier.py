...
SOLVER_COMMIT = "ee1b8fd39efab8c8ed8140bbebe4c08e778052b9"
RUNNER_COMMIT = "861a1f32073ba714a1bde555cea5d53f10a26b21"
...
def main():
    ...
    if not batch.is_relative_to(ROOT / "results/a/q2-nikolastarx/frontier-benchmark-s59ee-20260925"):
    ...
    runner_bytes = subprocess.check_output(["git", "show", f"{RUNNER_COMMIT}:src/local_benchmarks/s59ee_p2_frontier.py"], cwd=ROOT)
    ...
    for case, core_text in requested:
        ...
        record = {
            "attempt_id": f"nikolastarx-s59ee-p2-frontier-{case}-k{k}-r0",
            "revision": 1,
            "run_id": meta["batch_id"],
            "algorithm_id": "q2-adaptive-frontier",
            "algorithm_name": "P2 组件压力与共享输入波次求解",
            "variant": "component-pressure-shared-wave-dag",
            ...
            "parameters": {"cores": k, "candidate_limit": 1, "online_evaluator_calls": 0,
                           ...
                           "solver_timeout_seconds": 25, "evaluation_timeout_seconds": 50,
            ...
            "provenance": {
                ...
                "solver": {"source": {"repo": "huaweibei123/huaweicup2026", "commit": SOLVER_COMMIT,
                                      "path": "src/q2_nikolastarx/adaptive_frontier.py", "entrypoint": "main"},
                           "authors": ["NikolaStarx"],
                           "method": "deterministic component pressure and shared-input wave routing with one published candidate per coordinate and zero online E0/E1/E2 calls",
                           "references": ["https://github.com/huaweibei123/huaweicup2026/blob/" + SOLVER_COMMIT + "/src/q2_nikolastarx/adaptive_frontier.py"],
                ...
                "runner": {"source": {"repo": "huaweibei123/huaweicup2026", "commit": RUNNER_COMMIT,
                                      "path": "src/local_benchmarks/s59ee_p2_frontier.py", "entrypoint": "main"},
                           "argv": ["python", "-B", "src/local_benchmarks/s59ee_p2_frontier.py",
                ...
                "measurement": {"started_at": run["started_at"] if run["status"] != "not_run" else None,
                                ...
                                "budget": {"wall_seconds": 25, "candidate_limit": 1,
            ...
            "notes": ["P2 adaptive-frontier unified source: 100 original cases x 1-5 cores, 500 coordinates. Old b7 semantic full500 and ee1 small probes are not mixed here.",
