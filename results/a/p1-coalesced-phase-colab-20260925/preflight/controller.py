...
SESSION='p1-coalesced-008-k5-20260925'
BUNDLE_REMOTE='/content/coalesced-source-bundle.tar.gz'
ARCHIVE_REMOTE='/content/p1_coalesced_phase_window/evidence.tar.gz'
...
def sources(pin):
 ...
 if locked.get('source_commit')!='77977e3000904a47013458e666fee1ecddefb5de' or locked.get('graph_sha256')!='c93bb7ab5deec5112aff0cc001fbd76d001d3de5ea7463fba59b1f1ff2ba3e1d':raise ValueError('artifact manifest identity mismatch')
 ...
 required={'controller.py','controller_draft.py','remote_setup.py','coalesced-source-bundle.tar.gz','bundle-manifest.json'}
 if {r['path'] for r in rows}!=required:raise ValueError('artifact manifest coverage mismatch')
 return {'artifact_manifest_sha256':pin,'source_commit':'77977e3000904a47013458e666fee1ecddefb5de','graph_sha256':'c93bb7ab5deec5112aff0cc001fbd76d001d3de5ea7463fba59b1f1ff2ba3e1d','artifacts_verified':len(rows)}
...
def run_once(*,runner,watchdog_start,verify,now,persist,cli,artifact_manifest_sha256,session=SESSION,archive=None):
 ...
 try:
  ...
  r=bounded('upload-bundle',['upload','--session',session,str(HERE/'coalesced-source-bundle.tar.gz'),BUNDLE_REMOTE],25,200)
