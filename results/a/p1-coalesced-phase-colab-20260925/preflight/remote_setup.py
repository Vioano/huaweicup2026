"""Remote single-run coalesced phase pair; records diagnostics even after runner failure."""
import gzip,hashlib,json,os,pathlib,resource,shutil,signal,subprocess,sys,tarfile,time
BASE=pathlib.Path('/content/p1_coalesced_phase_window');BUNDLE=pathlib.Path('/content/coalesced-source-bundle.tar.gz')
WS=BASE/'workspace';EVID=BASE/'evidence';TARGET=WS/'evidence/coalesced-008-k5'
BUNDLE_SHA='f680062c292bae1a679c9253cc8bd8ef578b72a1dfe203d50b0ce9fa6c54a89d'
SOURCE='77977e3000904a47013458e666fee1ecddefb5de';GRAPH='c93bb7ab5deec5112aff0cc001fbd76d001d3de5ea7463fba59b1f1ff2ba3e1d'
COMMAND=['.venv/bin/python','-B','-m','src.review.p1_coalesced_phase_probe','case_008.json','--cores','5','--capacity-l1','524288','--capacity-ub','131072','--bandwidth','60','--gate','100','--q','7','--s','3','--period','35405','--chain-work','4512','--threshold','99264','--expect-graph-sha256',GRAPH,'--output-root','evidence/coalesced-008-k5','--execute']
...
def owned(pgid):
 ...
 return out
record={'status':'started','started_at':time.time(),'calls':{'Task_compile_attempts_upper_bound':27,'Task_compile_confirmed':None,'Fraction_attempts_upper_bound':2,'Fraction_confirmed':None,'E0':0,'E1':0,'E2':0,'retry':0}}
proc=None
