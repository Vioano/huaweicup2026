"""Evaluate exactly two already frozen C03 plans after an explicit resource gate."""
import argparse
import hashlib
import json
...
def main():
    ...
    assert gate['scope'] == 'c03-two-frozen-plans' and gate['status'] == 'admitted'
    ...
    assert expiry.tzinfo is not None and datetime.now(timezone.utc) < expiry
