"""Audit the saved 044/K5 Colab receipt without calling any evaluator."""
...
EXPECTED_RESULT_ZIP = '07352ae48b55d5a8e3bafc5f6e9d32bcb7fcf2b17135a8c862a4c33ce36c7d30'
...
def main() -> None:
    ...
    report = {
        'status': 'verified_negative_primary_result', 'case': '044', 'cores': 5,
        'fixed_package_commit': '65e677cd398f95bb1b273ca5a958c108ab833a05',
        ...
        'limits_and_caveats': ['This is one official case and one core count, not a full-algorithm score.',
                               ...
                               'Structural cause needs inspection of frozen task scheduling rules.'],
    }
