"""Hash-only source preflight and reproducible Colab capsule packer. Never runs a solver."""
...
SOLVER_SOURCE = '65b70e29e96115c1e365493a89f1e8a44339bc25'
...
SOURCE = ('direct.py', 'dag_direct.py', 'shared_input_wave.py',
          'shared_stationary_wave.py', 'evaluate_feedback.py')
...
def main():
    ...
    manifest = {'case': '044', 'cores': 5, 'solver_source_commit': SOLVER_SOURCE,
