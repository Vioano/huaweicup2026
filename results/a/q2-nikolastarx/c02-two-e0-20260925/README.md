...
Read-only per-operation finish-time comparison reinforces the distinction: candidate0 moves regional exit188 from8077 to6492 (-1585), but894 outside-region operations finish later; total M rises192. Candidate1 moves the same exit to6174 (-1903), but397 outside operations finish later; total M falls only124. All1032 original compute operations are matched by ID. `timeline-comparison.json` preserves counts and the largest delays. The original baseline timeline is the already-verified native diagnostic archive; candidate timelines are the two new official traces. No additional construction or scoring occurred.
