...
BASE=pathlib.Path('/content/p1_period7_window');BUNDLE=pathlib.Path('/content/p1-period7-source-bundle.tar.gz')
WS=BASE/'workspace'; EVID=BASE/'evidence'; TARGET=WS/'evidence/period7-008'
BUNDLE_SHA='49550ba410f732c2cc4032adca58765f33f76685a642280039455a18a958abb5'
MANIFEST_SHA='e09471fe0faa121505153f8c10bd2ae631e3f58dda5b29cf58346ac563a220dc'
COMMAND=['.venv/bin/python','-B','-m','src.review.p1_lazy_memory_probe','case_008.json','--cores','5','--capacity-l1','524288','--capacity-ub','131072','--bandwidth','60','--gate','100','--task-limit','40','--final-max-tasks','20','--response-limit','5','--oracle-limit','4','--expansion-limit','10','--seconds','30','--period-q','7','--period-s','3','--output-root','evidence/period7-008','--execute']
...
try:
 ...
 with tarfile.open(BUNDLE,'r:gz') as tf:
  ...
  assert manifest['source_commit']=='030f2b8aff4dc5e6b1acf9d88dc4984e54f1b5fa'
  WS.mkdir()
  for r in rows:
 ...
 with (EVID/'probe.stdout').open('xb') as so,(EVID/'probe.stderr').open('xb') as se:
  ...
  record['unknown_call_upper_bounds']={'Task_compile':40,'Fraction_response':5}
