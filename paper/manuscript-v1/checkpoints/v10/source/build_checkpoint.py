...
SOURCE_P=Path(os.environ.get('PAPER_SOURCE_ROOT', str(P/'review/code-compression-v10/content-source')))
...
# v10 content selection: full program listings are delivered in the source attachment.
...
receipt={'version':VERSION,'checkpoint':CHECKPOINT,'source_hashes':
         ...
         'code_files':0, 'external_code_files':len(code_manifest['files']),
