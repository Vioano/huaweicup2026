...
- 插入宽 148→146mm：148mm 时 Overfull vbox 6.7pt（内容超正文 2.4mm），146mm 后 0 警告；pdftotext 图号「图 5.1」不变。
- 字号更正（按公式 10×W/711×72/25.4）：6.58pt@165mm、5.83pt@146mm（148mm 口径 5.90pt）；v2/v3 的 5.90/5.66 系宽度口径不一致，已统一为实际值。
- 主图与其余附件字节不变；仅 PDF（重编译 705202a2…）、tex（宽度）更新；PNG 渲染确定性字节不变。
