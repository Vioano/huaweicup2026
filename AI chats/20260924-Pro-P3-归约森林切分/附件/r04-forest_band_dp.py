"""Integration adapter; copy this and grid_band_dp.py into src/q3/.

This adapter was syntax-checked, NOT executed on an official raw graph here.
...
from .grid_band_dp import construct_grid, row_block_word, coverage
